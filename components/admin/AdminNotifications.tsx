    ...
    <Popover>
      ...
      >
        ...
        <div className="border-t border-black/6 p-2">
          <Link
            href="/admin/orders"
            className="flex w-full items-center justify-center rounded-xl px-3 py-2.5 text-sm font-semibold text-shop_dark_green transition-colors hover:bg-shop_light_green/10"
          >
            View all orders
          </Link>
        </div>
